    ...
    const opts = {
      ...
      stateHandlers: {
        ...
        'category 1 exists with items': () => {
          ...
          // The route returns items from categoryItems, not items
          // The categoryItems object is NOT exported, so we can't modify it directly
          // The test will pass as long as the category exists
        },
